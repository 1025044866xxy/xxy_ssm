        ...
        <div class="hrms_main_ad col-sm-10">
            <div class="panel panel-success">
                <div class="panel-heading">
                    <h3 style="text-align: center;">欢迎进入商品管理系统！</h3>
                </div>
                    ...
                    <div id="hrms_carousel_1" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner" role="listbox">
                            <div class="item active" style="text-align: center;">
                                <img class="img-responsive center-block" src="img/1.jpg" alt="1">
                                <div class="carousel-caption">
                                    <h3>实惠</h3>
                                </div>
                            </div>
                            <div class="item">
                                <img class="img-responsive center-block" src="img/2.jpg" alt="2">
                                <div class="carousel-caption">
                                    <h3>极高的性价比</h3>
                                </div>
                            </div>
                            <div class="item">
                                <img class="img-responsive center-block" src="img/3.jpg" alt="3">
                                <div class="carousel-caption">
                                    <h3>快买</h3>
                                </div>
                            </div>
